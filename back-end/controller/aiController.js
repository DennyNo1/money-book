...
async function categorizeWechatRecordWithAI(req, res) {
    ...
    for (let i = 0; i < wechatRecords.length; i++) {
        ...
        proceededRecords.push(JSON.parse(recordAfterAI));
    }

    return res.status(200).json({
        message: "Success",
        data: proceededRecords
    });
}
...
module.exports = { aliAI, categorizeWechatRecordWithAI };
