const { createInvestItem, getInvestItem, makeInvest, getInvestmentHistory, deleteInvestItem, checkDuplicateInvestment, finishInvestment } = require("../controller/investController");
